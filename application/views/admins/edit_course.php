        ...
        <div class="card-body">
			...
			echo form_open_multipart('admin/editCourse/'.$course['course_id']); ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select id="lecturer_id" class="form-control" name="lecturer_id">
							<?php if ($course['lecturer_nic'] != "") { ?>
                                <option selected value="<?php echo $course['lecturer_nic']; ?>"><?php echo $teacher['fname']." ".$teacher['lname'] ?></option>
                            <?php } else { ?>
                                <option selected disabled> ----- Select Teacher ----- </option>
                            <?php }
                            foreach ($teachers as $teacher) { 
                                if ($course['lecturer_nic'] != $teacher['nic']) {?>
