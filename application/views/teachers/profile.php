        ...
        <div class="card">
            ...
            <?php if ($message != "") {
                ...
                <div class="row">
                    ...
                    <p class="col-sm-10 col-form-label"><?php echo $teacher['fname']." ".$teacher['lname']; ?></p>
                </div>
                <div class="row">
                    <label class="col-sm-2 col-form-label">Email Address: </label>
                    <p class="col-sm-10 col-form-label"><?php echo $teacher['email']; ?></p>
                </div>
                <div class="row">
                    <label class="col-sm-2 col-form-label">Home Address: </label>
                    <p class="col-sm-10 col-form-label"><?php echo $teacher['address']; ?></p>
                </div>
                <div class="row">
                    <label class="col-sm-2 col-form-label">Birthday: </label>
                    <p class="col-sm-10 col-form-label"><?php echo $teacher['birthday']; ?></p>
                </div>
                <div class="row">
                    <label class="col-sm-2 col-form-label">Gender: </label>
                    <p class="col-sm-10 col-form-label"><?php echo $teacher['gender']; ?></p>
                </div>
                <div class="row">
                    <label class="col-sm-2 col-form-label">Nationality: </label>
                    <p class="col-sm-10 col-form-label"><?php echo $teacher['nationality']; ?></p>
                </div>
                <div class="row">
                    <label class="col-sm-2 col-form-label">Telephone: </label>
                    <p class="col-sm-10 col-form-label"><?php echo $teacher['telephone']; ?></p>
                </div>  
                <div id="change-password">   
                    <?php echo validation_errors(); 
                    echo form_open_multipart('teachers/profile/'); ?>
                        <hr>
